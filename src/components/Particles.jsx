...
export const Particles = ({
  ...
  const animate = () => {
    ...
    circles.current.forEach((circle, i) => {
      ...
      circle.translateX +=
        (mouse.current.x / (15 / circle.magnetism) - circle.translateX) /
        20;
      circle.translateY +=
        (mouse.current.y / (15 / circle.magnetism) - circle.translateY) /
        20;
      ...
      for (let j = i + 1; j < circles.current.length; j++) {
        ...
        if (distance < 120) {
          ...
          const lineAlpha = (1 - distance / 120) * 0.3 * circle.alpha;
          context.current.strokeStyle = `rgba(${rgb.join(", ")}, ${lineAlpha})`;
